                    ...
                    @endcan
                        {{--  --}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="https://cdn.pixabay.com/photo/2020/07/01/12/58/icon-5359553_1280.png"></a>
								<div class="dropdown-menu">
                                    ...
                                    class="bx bx-log-out"></i>تسجيل خروج  Sign Out</a>
