				...
				<div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card mg-b-20">
                                <div class="pt-3 ">
                                    {{-- @can('تصدير EXCEL') --}}
                                    <a class="modal-effect btn btn-sm btn-primary" style="color:white; font-size:1.3em" href="{{ url('export_invoices') }}"
                                    style="color:white"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل</a>
                                    {{-- @endcan --}}
             {{-- @can('اضافة فاتورة') --}}
             <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white; font-size:1.3em"><i
